            ...
            <div id="invoiceContent">
                ...
                <div class="row">
                    <div class="col-xs-7">
                        ...
                        <strong v-if="sales.owner_name">Owner Name:</strong> {{ sales.owner_name }}<br v-if="sales.owner_name">
                            ...
                            <tbody>
                                <tr v-for="(product, sl) in cart">
                                    ...
                                    <td>{{ product.Product_Name }}
                                        <br>
                                        (<span  v-for="(Serial, ind) in product.serial.filter(sl => sl.sales_details_id == product.SaleDetails_SlNo) ">
