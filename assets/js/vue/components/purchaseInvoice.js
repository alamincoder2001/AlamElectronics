  ...
  template: `
        <div>
            ...
            <div id="invoiceContent">
                            ...
                            <tbody>
                                <tr v-for="(product, sl) in cart">
                                    ...
                                    <td>{{ product.Product_Name }}
                                        <br>
                                        (<span  v-for="(Serial, ind) in product.serial.filter(sl => sl.purchase_details_id == product.PurchaseDetails_SlNo) ">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <strong>In Word: </strong> {{ convertNumberToWords(purchase.PurchaseMaster_TotalAmount) }}<br>
                        <p style="white-space: pre-line;margin:0;"><strong>Note: </strong>{{ purchase.PurchaseMaster_Description }}</p>
                    </div>
                </div>
            </div>
        </div>
      ...
      printWindow.document.write(`
                ...
                <body>
                    <div class="container">
                                ...
                                <tr>
                                    <td>
                                        <div class="row">
                                            ...
                                            <div class="col-xs-12">
                                                <div style="border-bottom: 4px double #454545;padding-top:7px;margin-bottom:7px;"></div>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
                        ...
                        <div class="row" style="width:100%;position:fixed;bottom:0;left:0;margin:0;">
