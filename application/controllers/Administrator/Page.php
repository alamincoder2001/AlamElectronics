...
class Page extends CI_Controller {
    ...
    public function company_profile_insert(){
        ...
        if($image != ""){            
         ...
         if(isset($_FILES['poweredLogo'])){

            $config = [];
            $config['upload_path'] = './uploads/company_powered_logo/'; 
            $config['allowed_types'] = 'gif|jpg|png|jpeg';
            $config['max_size'] = '10000';
            $config['image_width']= '4000';
            $config['image_height']= '4000';
            ...
            $img=$this->upload->do_upload('poweredLogo');
            $thum = $this->upload->data();

            if($img != ""){            
                if($xx['Powered_Logo_thum']){
                unlink("./uploads/company_powered_logo/".$xx['Powered_Logo_thum']);
                }

                $data['Powered_Logo_thum'] = $thum['file_name'];
            }else{
                $data['Powered_Logo_thum'] = $xx['Powered_Logo_thum'];
            }
         }
    ...
    public function company_profile_Update(){
        ...
        if(!isset($_FILES['companyLogo']) || !isset($_FILES['poweredLogo']))
        {   
            $data['print_type'] = $inpt;
