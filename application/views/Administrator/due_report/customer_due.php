		...
		<div class="form-group">
			...
			<div class="col-sm-2">
				<select class="form-control" v-model="searchType" v-on:change="onChangeSearchType" style="padding:0px;">
					...
					<option value="retail">By Retail</option>
					<option value="wholesale">By Wholesale</option>
				</select>
			</div>
		</div>
	...
	new Vue({
		...
		methods:{
			...
			getDues(){
				...
				if(this.searchType == 'retail'){
					customer_type = 'retail';
				}else if(this.searchType == 'wholesale'){
					customer_type = 'wholesale';
				}
				axios.post('/get_customer_due', {customerId, districtId, customer_type}).then(res => {
