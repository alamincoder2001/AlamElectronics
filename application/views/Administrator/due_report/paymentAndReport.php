...
$totalDue = $type == 'CR' ? $prevdueAmont - ($CPROW->CPayment_amount + $CPROW->discount): $prevdueAmont + ($CPROW->CPayment_amount + $CPROW->discount);
            ...
            <div class="col-xs-12">
                <table class="border" cellspacing="0" cellpadding="0" style="width: 100%;">
                    ...
                    <tbody>
                        ...
                        <td style="text-align:right;"><?php echo number_format($CPROW->discount, 2);?></td>
                        </tr>
                        <tr>
                            ...
                            <th style="font-size: 13px; font-weight: 700;text-align:right;"><?php echo number_format($CPROW->discount, 2);?></th>
                        </tr>
                    </tbody>
                </table>
            </div>
            ...
            <div class="col-xs-12 text-left;">
                <table style="width: 25%;float:left;">
                    ...
                    <tr>
                        ...
                        <td  style="font-size: 13px; font-weight: 600; border-bottom: 2px solid #000; text-align: right; "><?php echo number_format($CPROW->discount, 2); ?></td>
                    </tr>
                    <tr>
