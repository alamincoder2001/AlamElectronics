			...
			<table class="table table-bordered">
				...
				<tbody>
					...
					<tr>
						...
						<th style="text-align:right;">{{payments.reduce((prev, curr)=>{ return prev + parseFloat(curr.bill)}, 0).toFixed(2)}}</th>
						<th style="text-align:right;">{{payments.reduce((prev, curr)=>{ return prev + parseFloat(curr.paid)}, 0).toFixed(2)}}</th>
						<th style="text-align:right;">{{payments.reduce((prev, curr)=>{ return prev + parseFloat(curr.due)}, 0).toFixed(2)}}</th>
						<th style="text-align:right;">{{payments.reduce((prev, curr)=>{ return prev + parseFloat(curr.returned)}, 0).toFixed(2)}}</th>
						<th style="text-align:right;">{{payments.reduce((prev, curr)=>{ return prev + parseFloat(curr.cash_received)}, 0).toFixed(2)}}</th>
						<th></th>
					</tr>
				</tbody>
