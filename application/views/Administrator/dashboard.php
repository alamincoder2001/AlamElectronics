...
if ($module == 'dashboard' or $module == '') { ?>
	<div class="row">
		<div class="col-md-12 col-xs-12">
			...
			<div class="col-md-10 col-md-offset-1">
				<div class="col-md-3 col-xs-12 section4">
 ...
 -->
				...
				<?php if (array_search("due_remainder", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
				<div class="col-md-3 col-xs-12 section4">
					<div class="col-md-12 section122" style="background-color:#ecffd9;" onmouseover="this.style.background = '#cfff9f'" onmouseout="this.style.background = '#ecffd9'">
						<a href="<?php echo base_url(); ?>due_remainder">
							<div class="logo">
				...
				<?php if (array_search("graph", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
				<div class="col-md-3 col-xs-12 section4">
