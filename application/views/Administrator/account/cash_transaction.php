				...
				<div class="row">
					...
					<div class="col-md-5">
						...
						<div class="form-group">
							...
							<label class="col-md-1">:</label>
							<div class="col-md-7">
								<input type="number" step="0.01" class="form-control" required v-model="transaction.In_Amount" 
									style="display:none;" 
									v-if="transaction.Tr_Type == 'In Cash'"
									v-bind:style="{display: transaction.Tr_Type == 'In Cash' ? '' : 'none'}"
								>
								<input type="number" step="0.01" class="form-control" required v-model="transaction.Out_Amount" 
