                ...
                <form id="accountForm" class="form-horizontal" @submit.prevent="saveAccount">
                    <div class="row">
                        <div class="col-md-4 col-md-offset-3">
                            ...
                            <div class="form-group">
                                <label class="control-label col-md-4">Is Investment</label>
                                <div class="col-md-8">
                                    <input type="checkbox" v-model="account.is_investment">
                                </div>
                            </div>
                            ...
                            <datatable :columns="columns" :data="accounts" :filter-by="filter">
                                <template scope="{ row }">
                                    <tr>
                                        ...
                                        <td>{{ row.is_investment  == 1 ? 'Yes' : 'No' }}</td>
                                        <td>
    ...
    new Vue({
        ...
        data(){
            return {
                ...
                columns: [
                    ...
                    { label: 'Is investment', field: 'is_investment', align: 'center' },
        ...
        methods: {
            ...
            editAccount(account){
                ...
                this.account.is_investment = parseInt(account.is_investment);
            },
