                            ...
                            <div class="col-md-9">
                                <form v-on:submit.prevent="addToCart()">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-8">
                                            <v-select id="product" v-bind:options="products" v-model="selectedProduct" label="Product_Name" v-on:input="onChangeProduct"></v-select>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-8">
                                            <input type="number" class="form-control" v-model="quantity" ref="quantity" required v-on:input="productTotal" v-bind:disabled="serials.length ? true : false">
                                        </div>
                                    </div>
                                    <div class="form-group">
