...
<div id="customers">
		...
		<div class="row" style="margin-top: 10px;margin-bottom:15px;border-bottom: 1px solid #ccc;padding-bottom:15px;">
			<div class="col-md-5">
				...
				<div class="form-group clearfix">
					<label class="control-label col-md-4">Customer NID:</label>
					<div class="col-md-7">
						<input type="text" class="form-control" v-model="customer.nid">
					</div>
				</div>
		...
		data(){
			return {
				...
				columns: [
                    ...
                    { label: 'Customer Nid', field: 'Customer_Code', align: 'center', filterable: false },
