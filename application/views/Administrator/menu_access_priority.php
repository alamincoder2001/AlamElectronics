        ...
        <div class="col-md-3">
            <div class="group">
                ...
                <ul ref="sales">
                    ...
                    <li><input type="checkbox" class="access" value="returnIemi" v-model="access"> Sale Return</li>
                    ...
                    <li><input type="checkbox" class="access" value="serial_stock" v-model="access"> Serial Stock</li>
            ...
            <div class="group">
                ...
                <ul ref="accounts">
                    ...
                    <li><input type="checkbox" class="access" value="customer_payment_discount" v-model="access"> Customer Payment Discount</li>
                    <li><input type="checkbox" class="access" value="supplierPayment" v-model="access"> Supplier Payment</li>
                    <li><input type="checkbox" class="access" value="installment_collection" v-model="access"> Installment Collection</li>
        ...
        <div class="col-md-3">
            <div class="group">
                ...
                <ul ref="salesReports">
                    ...
                    <li><input type="checkbox" class="access" value="installment_sales_report" v-model="access"> Installment Sales Report</li>
                    <li><input type="checkbox" class="access" value="installment_salesrecord" v-model="access"> Installment Sales Record</li>
                    <li><input type="checkbox" class="access" value="installment_sales_target" v-model="access"> Installment Sales Target</li>
                </ul>
            </div>
        ...
        <div class="col-md-3">
            <div class="group">
                ...
                <ul ref="purchase">
                    ...
                    <li><input type="checkbox" class="access" value="purchaseReturnsImei" v-model="access"> Purchase Return</li>
            ...
            <div class="group">
                <input type="checkbox" id="hrPayroll" class="group-head" @click="onClickGroupHeads"> <strong>Service</strong>
                <ul ref="hrPayroll">
                    <li><input type="checkbox" class="access" value="service" v-model="access"> Service Entry</li>
                    <li><input type="checkbox" class="access" value="service_company" v-model="access"> Service Company</li>
                    <li><input type="checkbox" class="access" value="serviceRecord" v-model="access"> Service Record</li>
                    <li><input type="checkbox" class="access" value="serviceStock" v-model="access"> Service In Stock</li>
                    <li><input type="checkbox" class="access" value="serviceOutStock" v-model="access"> Service Out Stock</li>
                </ul>
            </div>
        </div>
        <div class="col-md-3">
            <div class="group">
                ...
                <ul ref="purchaseReports">
                    ...
                    <li><input type="checkbox" class="access" value="over_date_serial" v-model="access"> Over Date Serial</li>
                </ul>
            </div>
            <div class="group">
                ...
                <ul ref="admin">
                    ...
                    <li><input type="checkbox" class="access" value="due_remainder" v-model="access"> Due Remainder</li>
                </ul>
            </div>
        </div>
    </div>
